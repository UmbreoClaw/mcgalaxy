...
namespace MCGalaxy.Commands.Info 
{
    public sealed class CmdOpStats : Command2 
    {
        ...
        public override void Use(Player p, string message, CommandData data) {
            ...
            p.Message(Locale.Get("opstats.header", p), p.FormatNick(name), start);
            ...
            p.Message(Locale.Get("opstats.bans", p),
                           bans + kickbans + xbans, ipbans + xbans, tempbans);
            p.Message(Locale.Get("opstats.mutes", p),
                           mutes, warns, freezes, kicks + kickbans + xbans);
            p.Message(Locale.Get("opstats.reviews", p),
        ...
        public override void Help(Player p) {
            p.Message(Locale.Get("opstats.help1", p));
            p.Message(Locale.Get("opstats.help2", p));
        }
    }
}
