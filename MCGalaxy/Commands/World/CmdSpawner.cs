...
{
    /// <summary> Reports natural-spawn statistics and the survival clock state
    /// for the current level. Split out of /Survival (was "/Survival spawner"). </summary>
    public sealed class CmdSpawner : Command2
    {
