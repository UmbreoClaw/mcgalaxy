...
namespace MCGalaxy.Commands.Bots 
{
    public sealed class CmdBotSummon : Command2
    {
        ...
        public override void Help(Player p) {   
            p.Message(Locale.Get("cmd.botsummon.help1", p));
            p.Message(Locale.Get("cmd.botsummon.help2", p));
            p.Message(Locale.Get("cmd.botsummon.help3", p));
            p.Message(Locale.Get("cmd.botsummon.help4", p));
            p.Message(Locale.Get("cmd.botsummon.help5", p));
        }
    }
}
